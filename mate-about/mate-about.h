...
const char* program_name = N_("MATI Desktop Environment");
...
const char* copyright =  N_("Copyright © 1997-2011 GNOME developers\n"
                            ...
                            "Copyright © 2021-2022 Bengal Dev");
...
const char* comments_array[] = {
    ...
    "using traditional metaphors. On the other hand Mati is the rebuild of Mate, Cheers!")
};
